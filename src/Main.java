...
public class Main {
    ...
    public Main(){
        ...
        graph3 = new GraphForMatrix<>(false);
    }
    ...
    public static void main(String[] args) {
        ...
        m.graph2.addEdge("b", "c", 10);
        m.graph2.addEdge("c", "a", 3);
        m.graph2.addEdge("b", "d", 4);
        m.graph2.addEdge("d", "c", 2);
        m.graph2.addEdge("d", "e", 1);
        m.graph2.addEdge("e", "c", 6);
        m.graph2.dijkstra("b");
        m.graph2.prim("b");
        System.out.println("");
